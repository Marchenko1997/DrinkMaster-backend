...
import {fullYearsCount} from "../../helpers/index.js";

export const getDrinksByFilters = async (req, res) => {
    ...
    if (ingredient) query["ingredients.title"] = { $regex: ingredient, $options: 'i' };
